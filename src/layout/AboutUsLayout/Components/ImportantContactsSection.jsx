    ...
    <div className="pb-5">
      <div className="position-relative py-5">
        ...
        <div className="row mx-2 mx-md-5 px-1 justify-content-center">
          {contacts.map((data) => (
            <div className="px-2 py-2 py-md-4 col-6 col-sm-4 col-xxl-3">
              <ContactCard name={data.name} designation={data.designation} email={data.email} />
            </div>
          ))}
        </div>

        <img src="./assets/icons/4x5.svg" className="position-absolute" style={{ bottom: width > 768 ? "4rem" : "3rem", left: width > 768 ? "4rem" : "0.5rem", zIndex: "-1" }} />
        {width > 768 && <img src="./assets/icons/4x5.svg" className="position-absolute" style={{ bottom: "4rem", right: "4rem", zIndex: "-1" }} />}
      </div>
