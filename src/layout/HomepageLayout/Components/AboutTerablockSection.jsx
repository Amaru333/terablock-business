    ...
    <div className="py-5 px-2 px-md-5" style={{ backgroundColor: "#0251ff" }}>
      ...
      <div className="row mx-0 pt-5">
        ...
        <div className="col-6 col-md-4 pb-5">
          <div className="px-0 px-md-4">
            <img src="./assets/images/non-custodial.png" />
            <p className="text-white my-2 fw-normal fs-5">Simple Fees Structure</p>
            <p className="text-white fs-6 fw-light">No subscription or management fees. Only pay a standard trading fee.</p>
          </div>
        </div>
        <div className="col-6 col-md-4 pb-5">
          <div className="px-0 px-md-4">
